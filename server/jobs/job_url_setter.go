...
//go:generate mockgen -package mocks -destination mocks/mock_project_job_url_generator.go . ProjectJobURLGenerator
...
//go:generate mockgen -package mocks -destination mocks/mock_project_status_updater.go . ProjectStatusUpdater
