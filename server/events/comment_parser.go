...
//go:generate mockgen -package mocks -destination mocks/mock_comment_parsing.go . CommentParsing
...
//go:generate mockgen -package mocks -destination mocks/mock_comment_building.go . CommentBuilder
