...
//go:generate mockgen -package mocks -destination mocks/mock_slack_client.go . SlackClient
...
//go:generate mockgen -package mocks -destination mocks/mock_underlying_slack_client.go . UnderlyingSlackClient
